...
RSpec.describe SurveyResponsesController, type: :controller do
  ...
  describe "GET #show" do
    it "returns a success response" do
      survey_response = SurveyResponse.create! valid_attributes
      get :show, params: {id: survey_response.to_param}, session: valid_session
      expect(response).to be_success
    end
  end
  ...
  describe "GET #edit" do
    it "returns a success response" do
      survey_response = SurveyResponse.create! valid_attributes
      get :edit, params: {id: survey_response.to_param}, session: valid_session
      expect(response).to be_success
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new SurveyResponse" do
        expect {
          post :create, params: {survey_response: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {survey_response: invalid_attributes}, session: valid_session
        expect(response).to be_success
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested survey_response" do
        survey_response = SurveyResponse.create! valid_attributes
        put :update, params: {id: survey_response.to_param, survey_response: new_attributes}, session: valid_session
      ...
      it "redirects to the survey_response" do
        survey_response = SurveyResponse.create! valid_attributes
        put :update, params: {id: survey_response.to_param, survey_response: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        survey_response = SurveyResponse.create! valid_attributes
        put :update, params: {id: survey_response.to_param, survey_response: invalid_attributes}, session: valid_session
        expect(response).to be_success
      end
    end
  end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested survey_response" do
      survey_response = SurveyResponse.create! valid_attributes
      expect {
        delete :destroy, params: {id: survey_response.to_param}, session: valid_session
      }.to change(SurveyResponse, :count).by(-1)
    end
